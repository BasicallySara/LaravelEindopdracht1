        ...
        <div>
            <div class="bg-white shadow-md rounded my-6 p-6">
                <div class="bg-gray-800 text-white p-4 rounded-t">
                    <h3 class="text-xl">Create Product</h3>
                </div>
                <form enctype="multipart/form-data" action="{{ route('products.store') }}" method="post" class="space-y-6">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <input value="{{ old('price') }}" type="text" name="price" placeholder="Price"
                    ...
                    <div>
                        ...
                        <textarea name="description" cols="30" rows="5" placeholder="Description"
                            class="w-full px-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-gray-300">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div>
                        <button type="submit" class="w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-500">Submit</button>
                    </div>
                </form>
            </div>
        </div>
